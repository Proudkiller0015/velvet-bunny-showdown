 ...
 *     on it forever
 *   - `js/velvet-data.js` adds Samantha to the dex the client loaded, and
 *     `js/velvet-buffs.js` before it carries the Pokemon this server
 *     buffs - both must come after their data files and before the search
