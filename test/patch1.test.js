...
check(['walkingwake', 'dragapult', 'dragonitemega', 'lucariomegaz', 'deoxysspeed', 'greninjabond', 'magearna', 'magearnaoriginal', 'roaringmoon', 'ursalunabloodmoon', 'zeraoramega', 'heatranmega', 'blazikenmega', 'gliscor', 'pheromosa', 'genesect', 'genesectdouse', 'genesectshock', 'genesectburn', 'genesectchill'].every(id => Dex.species.get(id).natDexTier === 'OU'), 'Walking Wake, Dragapult, Mega Dragonite, Mega Lucario Z, Deoxys-Speed, Ash-Greninja, Magearna, Roaring Moon, Bloodmoon Ursaluna, Mega Zeraora, Mega Heatran, Mega Blaziken, Gliscor, Pheromosa and Genesect are unbanned (OU)');
{
	const vm = require('vm');
	const ctx = { window: {} };
